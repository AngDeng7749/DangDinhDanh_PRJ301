...
import javax.servlet.annotation.WebServlet; // Thêm dòng import này

@WebServlet(name = "UniversityController", urlPatterns = {"/UniversityController"}) // Thêm cấu hình này
/**
 *
 * @author AngDeng
 */
